...
class MainWindow(QWidget):                           # <===
    def __init__(self, generator_options):
        ...
        self.max_objs_thresh = self.generator_options.get_max_objects()
        self.aig_form()
    ...
    def aig_form(self):
        ...
        self.nameLabel_max_objects.setText('Maximum objects:  (<='+str(self.max_objs_thresh)+')')
        ...
        self.max_objects.setText(str(self.generator_options.get_max_objects()))
        self.max_objects.textChanged.connect(self.button_status)
        ...
        self.image_folder.setText(self.generator_options.get_image_path())
        ...
        self.label_folder.setText(self.generator_options.get_label_path())
        ...
        self.labels_file_path.setText(self.generator_options.get_labels_file_path())
    ...
    def button_status(self):
        if len(self.num_images.text()) > 0 \
                and self.image_folder.text() != self.home_path \
                and self.label_folder.text() != self.home_path \
                and self.backgrounds_folder.text() != self.home_path \
                and self.max_objs_thresh >= int(self.max_objects.text()):
    ...
    def ok_button(self):
        ...
        self.generator_options.set_image_path(self.image_folder.text()+"/temp/")
        self.generator_options.set_label_path(self.label_folder.text()+"/temp/")
        self.generator_options.set_backgrounds_path(self.backgrounds_folder.text()+"/temp/")
        ...
        self.generator_options.set_image_save_path(self.image_save_path.text()+"/augmented/images")
        self.generator_options.set_label_save_path(self.image_save_path.text()+"/augmented/labels")
        self.generator_options.set_labels_file_path(self.labels_file_path.text())
        self.generator_options.set_save_mask(self.save_mask_flag)
        self.generator_options.set_mask_save_path(self.image_save_path.text()+"/augmented/masks")
